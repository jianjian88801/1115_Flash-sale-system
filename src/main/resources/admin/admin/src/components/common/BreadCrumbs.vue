<template>
  <el-breadcrumb class="app-breadcrumb" separator="<<" style="height:50px;backgroundColor:rgba(255, 215, 0, 0);borderRadius:0;padding:0;boxShadow:0px 0px 0px rgba(255, 191, 182, 1);borderWidth:0px 0px 0px 0px;borderStyle:dotted;borderColor:rgba(255, 191, 182, 1);">
